#####IMPORTANT#####
#this program should only be run from a directory that contains the tools/fastgcd directory.
#this program should only be run on a linux machine that has installed the apropriate pachages with the following commands
#
# ./install.sh (in the fastgcd directory)
#sudo easy_install pip
#sudo pip install pycrypto
#sudo pip install rsa
#
#
#this program reads the files Public-keyA.txt and Public-KeyB.txt. Usinf fastgcd it calculated their private keys and outpouts them to PrivateKeyA.pem and privateKeyB.pem.
