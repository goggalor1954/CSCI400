...
//a fb_element for large primes, we don't need some
//of the auxillary info.  for instance, we won't be
//testing if on a progression during trial division, so  
//can get rid of small_inv, correction, and shift.  also
//may be slower to carry around the exact division inverse
//than is gained by performing exact division....
