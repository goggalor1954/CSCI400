...
#define SQRADD(i, j)                                 \
   do { fp_word t;                                   \
   t = c0 + ((fp_word)i) * ((fp_word)j);  c0 = (uint32)t;    \
   t = c1 + (t >> DIGIT_BIT);             c1 = (uint32)t; c2 += (uint32)(t >> DIGIT_BIT); \
   } while (0);
...
#define SQRADD2(i, j)                                                 \
   ...
   tt = (fp_word)c0 + t;                 c0 = (uint32)tt;                              \
   tt = (fp_word)c1 + (tt >> DIGIT_BIT); c1 = (uint32)tt; c2 += (uint32)(tt >> DIGIT_BIT);       \
   tt = (fp_word)c0 + t;                 c0 = (uint32)tt;                              \
   tt = (fp_word)c1 + (tt >> DIGIT_BIT); c1 = (uint32)tt; c2 += (uint32)(tt >> DIGIT_BIT);       \
   } while (0);
...
#define SQRADDSC(i, j)                                                         \
   do { fp_word t;                                                             \
      t =  ((fp_word)i) * ((fp_word)j);                                        \
      sc0 = (uint32)t; sc1 = (uint32)(t >> DIGIT_BIT); sc2 = (uint32)0;                      \
   } while (0);

#define SQRADDAC(i, j)                                                         \
   do { fp_word t;                                                             \
   t = sc0 + ((fp_word)i) * ((fp_word)j);  sc0 = (uint32)t;                            \
   t = sc1 + (t >> DIGIT_BIT);             sc1 = (uint32)t; sc2 += (uint32)(t >> DIGIT_BIT);     \
   } while (0);

#define SQRADDDB                                                               \
   do { fp_word t;                                                             \
   t = ((fp_word)sc0) + ((fp_word)sc0) + c0; c0 = (uint32)t;                                                 \
   t = ((fp_word)sc1) + ((fp_word)sc1) + c1 + (t >> DIGIT_BIT); c1 = (uint32)t;                              \
   c2 = c2 + (uint32)((fp_word)sc2) + ((fp_word)sc2) + (uint32)(t >> DIGIT_BIT);                                     \
   } while (0);
