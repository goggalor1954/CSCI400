...
{
	uint32 prime, root1, root2, tmp, stop, p16, p2;
	...
	for (j=0;j<lp->num_slices;j++)
	{
		...
		//for (i = lpnum; i > (lpnum & 15); i -=16)
		{
			...
			sieve[bptr[i  ].loc] -= logp;
			sieve[bptr[i+1].loc] -= logp;
			sieve[bptr[i+2].loc] -= logp;
			sieve[bptr[i+3].loc] -= logp;
			sieve[bptr[i+4].loc] -= logp;
			sieve[bptr[i+5].loc] -= logp;
			sieve[bptr[i+6].loc] -= logp;
			sieve[bptr[i+7].loc] -= logp;
			sieve[bptr[i+8].loc] -= logp;
			sieve[bptr[i+9].loc] -= logp;
			sieve[bptr[i+10].loc] -= logp;
			sieve[bptr[i+11].loc] -= logp;
			sieve[bptr[i+12].loc] -= logp;
			sieve[bptr[i+13].loc] -= logp;
			sieve[bptr[i+14].loc] -= logp;
			sieve[bptr[i+15].loc] -= logp;			
		}
